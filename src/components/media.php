...
function renderMedia($type, $content)
{
  switch ($type) {
    ...
    case 'youtube':
      ...
      break;
    case 'facebook':
      echo '<div id="fb-root"></div><script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v19.0" nonce="r1vN9evv"></script> <div class="fb-video" data-href="' .
        htmlspecialchars($content, ENT_QUOTES, 'UTF-8') .
